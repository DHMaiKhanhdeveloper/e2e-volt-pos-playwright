...
> Tổng: **270 test case** trong **70 file**.
>
...
| 2   | Orders — create order @regression @payment › does not allow pay without selecting a service       | `npx playwright test e2e/orders/createOrder.e2e.spec.ts:60` |
| 3   | Orders — create order @regression @payment › creates an order with multiple services              | `npx playwright test e2e/orders/createOrder.e2e.spec.ts:65` |
| 4   | Orders — create order @regression @payment › creates order with single service and pays with cash | `npx playwright test e2e/orders/createOrder.e2e.spec.ts:89` |
...
### `portal/auth.setup.ts` _(project: portal-auth)_

Chạy cả file:

```bash
npx playwright test portal/auth.setup.ts
```

| #   | Test case                      | Command                                       |
| --- | ------------------------------ | --------------------------------------------- |
| 1   | authenticate to FASTBOY Portal | `npx playwright test portal/auth.setup.ts:20` |

### `portal/staff-payroll-compare.spec.ts` _(project: chromium)_

Chạy cả file:

```bash
npx playwright test portal/staff-payroll-compare.spec.ts
```

| #   | Test case                                                                                                     | Command                                                        |
| --- | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| 1   | Staff Payroll — cross-app parity (Volt POS vs Portal) › every period in the dropdown: every staff row matches | `npx playwright test portal/staff-payroll-compare.spec.ts:377` |
| 2   | Staff Payroll — cross-app parity (Volt POS vs Portal) › every period in the dropdown: every staff row matches | `npx playwright test portal/staff-payroll-compare.spec.ts:377` |
...
### `regression/incomes/income-reports-v2/TC-income-reports-v2-compare.spec.ts` _(project: no-retry)_

Chạy cả file:

```bash
npx playwright test regression/incomes/income-reports-v2/TC-income-reports-v2-compare.spec.ts
```
...
| #   | Test case                                                                                           | Command                                                                        |
| --- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 1   | Orders — bulk create 10 orders @regression @slow › Order 1/10: Gel Polish Removal                   | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 2   | Orders — bulk create 10 orders @regression @slow › Order 2/10: Ombre'                               | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 3   | Orders — bulk create 10 orders @regression @slow › Order 3/10: Acrylic Soak-Off                     | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 4   | Orders — bulk create 10 orders @regression @slow › Order 4/10: Lip                                  | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 5   | Orders — bulk create 10 orders @regression @slow › Order 5/10: Deluxe Pedicure                      | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 6   | Orders — bulk create 10 orders @regression @slow › Order 6/10: Gel Polish Removal + Ombre'          | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 7   | Orders — bulk create 10 orders @regression @slow › Order 7/10: Acrylic Soak-Off + Lip               | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 8   | Orders — bulk create 10 orders @regression @slow › Order 8/10: Deluxe Pedicure + Gel Polish Removal | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 9   | Orders — bulk create 10 orders @regression @slow › Order 9/10: Ombre' + Acrylic Soak-Off            | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
| 10  | Orders — bulk create 10 orders @regression @slow › Order 10/10: Lip + Deluxe Pedicure               | `npx playwright test regression/orders/bulkCreateOrders.regression.spec.ts:24` |
...
| 4   | Order Flow — Checkout @regression @ui @payment › TC-ORDERFLOW-46: Other payment requires a method name and echoes it on success                                                                              | `npx playwright test regression/pos/order-flow/checkout.spec.ts:90`  |
| 5   | Order Flow — Checkout @regression @ui @payment › TC-ORDERFLOW-47: Tip is disabled before a payment method is chosen                                                                                          | `npx playwright test regression/pos/order-flow/checkout.spec.ts:111` |
| 6   | Order Flow — Checkout @regression @ui @payment › TC-ORDERFLOW-43/45/48/49/50/51/52/53: multi-pay, Gift Card redemption, Print preview, Cash Drawer, Payment Success actions, and network-disconnect handling | `npx playwright test regression/pos/order-flow/checkout.spec.ts:122` |
...
| #   | Test case                                                                                                                           | Command                                                                  |
| --- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| 1   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-01: Home shows Staff / Service / Cart blocks                               | `npx playwright test regression/pos/order-flow/create-order.spec.ts:24`  |
| 2   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-02: choosing a Service before Staff shows "Select Staff First"             | `npx playwright test regression/pos/order-flow/create-order.spec.ts:31`  |
| 3   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-03: selecting Staff then Service adds a cart line                          | `npx playwright test regression/pos/order-flow/create-order.spec.ts:51`  |
| 4   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-04: staff search filters the staff list                                    | `npx playwright test regression/pos/order-flow/create-order.spec.ts:58`  |
| 5   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-05: service search filters the catalogue                                   | `npx playwright test regression/pos/order-flow/create-order.spec.ts:67`  |
| 6   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-06: New Customer — valid phone opens Add New Customer dialog               | `npx playwright test regression/pos/order-flow/create-order.spec.ts:75`  |
| 7   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-09: Skip customer entry shows "Unknown"                                    | `npx playwright test regression/pos/order-flow/create-order.spec.ts:86`  |
| 8   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-13: Quick Pay without a staff shows the guard popup                        | `npx playwright test regression/pos/order-flow/create-order.spec.ts:95`  |
| 9   | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-14: Quick Pay dialog exposes Amount / Service Name / Note / Discount / Add | `npx playwright test regression/pos/order-flow/create-order.spec.ts:111` |
| 10  | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-15: Quick Pay Add enables only once Amount + Service Name are filled       | `npx playwright test regression/pos/order-flow/create-order.spec.ts:133` |
| 11  | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-18: Promo & Rewards opens the Add Promo dialog                             | `npx playwright test regression/pos/order-flow/create-order.spec.ts:156` |
| 12  | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-19: Note button opens an order-note editor                                 | `npx playwright test regression/pos/order-flow/create-order.spec.ts:166` |
| 13  | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-21: Cart summary shows Subtotal / Tax / Total                              | `npx playwright test regression/pos/order-flow/create-order.spec.ts:176` |
| 14  | Order Flow — Create Order @regression @ui › TC-ORDERFLOW-07/08/10/11/12/16/17/20/22/23/24: covered by spec — needs seeded data      | `npx playwright test regression/pos/order-flow/create-order.spec.ts:191` |
...
| 2   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-55: Successful - Unsettled order exposes Receipt / Re-Open / Cancel                                                                                                             | `npx playwright test regression/pos/order-flow/order-management.spec.ts:41`  |
| 3   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-56: Successful - Settled order exposes Receipt / Refund / Partial Refund                                                                                                        | `npx playwright test regression/pos/order-flow/order-management.spec.ts:52`  |
| 4   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-57: Canceled order shows only Receipt + Cancel Information                                                                                                                      | `npx playwright test regression/pos/order-flow/order-management.spec.ts:64`  |
| 5   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-58: Refunded order shows only Receipt + Refund Information                                                                                                                      | `npx playwright test regression/pos/order-flow/order-management.spec.ts:75`  |
| 6   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-59: Partial Refunded order exposes Receipt + Refund + Partial Refund                                                                                                            | `npx playwright test regression/pos/order-flow/order-management.spec.ts:85`  |
| 7   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-60: Refund disabled with "Refund Not Available" when card txn not batch-closed                                                                                                  | `npx playwright test regression/pos/order-flow/order-management.spec.ts:97`  |
| 8   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-63: Refund dialog exposes service selection, method, amount, reason                                                                                                             | `npx playwright test regression/pos/order-flow/order-management.spec.ts:110` |
| 9   | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-64: Cancel Order confirm dialog opens on an Unsettled order                                                                                                                     | `npx playwright test regression/pos/order-flow/order-management.spec.ts:123` |
| 10  | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-66: "Continue Re-open" shown for an order mid-reopen                                                                                                                            | `npx playwright test regression/pos/order-flow/order-management.spec.ts:135` |
| 11  | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-61/62/65/67/68/69/70: refund autofill math, single-reopen-only rule, Void all, locked fields on reopen, Adjust Tip gating — require destructive mutations on shared demo orders | `npx playwright test regression/pos/order-flow/order-management.spec.ts:146` |
| 12  | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-74: global Search exposes 5 result tabs                                                                                                                                         | `npx playwright test regression/pos/order-flow/order-management.spec.ts:160` |
| 13  | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-75: searching by Order ID opens the matching Order History row                                                                                                                  | `npx playwright test regression/pos/order-flow/order-management.spec.ts:182` |
| 14  | Order Flow — Order Management @regression @ui › TC-ORDERFLOW-71/72/73: Cash Drawer / Scan (Barcode/QR Gift Card, Order QR) — hardware/scanner dependent                                                                                      | `npx playwright test regression/pos/order-flow/order-management.spec.ts:193` |
...
### `regression/settings/TC-passcode-setting.spec.ts` _(project: chromium)_

Chạy cả file:

```bash
npx playwright test regression/settings/TC-passcode-setting.spec.ts
```

| #   | Test case                                                                                                                            | Command                                                                  |
| --- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| 1   | Settings — Passcode Setting @regression › TC-PASSCODE-01: default state is ON                                                        | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:32` |
| 2   | Settings — Passcode Setting @regression › TC-PASSCODE-02: turning OFF hides the passcode dialog on a gated route                     | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:36` |
| 3   | Settings — Passcode Setting @regression › TC-PASSCODE-03: turning back ON shows the passcode dialog again                            | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:50` |
| 4   | Settings — Passcode Setting @regression › TC-PASSCODE-04: OFF state persists across a full reload                                    | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:68` |
| 5   | Settings — Passcode Setting @regression › TC-PASSCODE-05: toggling Passcode Setting does not affect Keyboard Setting                 | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:80` |
| 6   | Settings — Passcode Setting @regression › TC-PASSCODE-06: setting syncs to a second session of the same merchant (known bug VP-2586) | `npx playwright test regression/settings/TC-passcode-setting.spec.ts:97` |
...
### `tmp-verify-detail.spec.ts` _(project: chromium)_

Chạy cả file:

```bash
npx playwright test tmp-verify-detail.spec.ts
```

| #   | Test case                  | Command                                           |
| --- | -------------------------- | ------------------------------------------------- |
| 1   | verify detail panel reader | `npx playwright test tmp-verify-detail.spec.ts:6` |
